...
namespace evc.Plugins.org.apache.cordova
{
    ...
    public class Compass : BaseCommand
    {
        ...
        /// Compass
        /// </summary>
        private static Microsoft.Devices.Sensors.Compass compass = new Microsoft.Devices.Sensors.Compass();
        ...
        public void startWatch(string options)
        {
            ...
            try
            {
                compassOptions = JsonHelper.Deserialize<CompassOptions>(options);
            }
            catch (Exception ex)
            {
