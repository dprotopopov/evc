...
namespace evc.Plugins.org.apache.cordova.media
{
    /// <summary>
    ...
    public class Media : BaseCommand
    {
        ...
        public void release(string options)
        {
            ...
            try
            {
                ...
                try
                {
                    string[] optionsString = JsonHelper.Deserialize<string[]>(options);
        ...
        public void stopRecordingAudio(string options)
        {
            ...
            try
            {
                string[] optStrings = JsonHelper.Deserialize<string[]>(options);
        ...
        public void stopPlayingAudio(String options)
        {
            ...
            try
            {
                string[] optionsStrings = JsonHelper.Deserialize<string[]>(options);
