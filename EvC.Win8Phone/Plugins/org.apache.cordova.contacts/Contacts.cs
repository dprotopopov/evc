...
namespace evc.Plugins.org.apache.cordova.contacts
{
    [DataContract]
    ...
    public class Contacts : BaseCommand
    {
        ...
        public void save(string jsonContact)
        {
            ...
            string[] args = JsonHelper.Deserialize<string[]>(jsonContact);


            JSONContact contact = JsonHelper.Deserialize<JSONContact>(args[0]);
        ...
        private void ContactSaveTaskCompleted(object sender, SaveContactResult e)
        {
            ...
            if (e.TaskResult == TaskResult.OK)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                    {
                        var deviceContacts = new Microsoft.Phone.UserData.Contacts();
        ...
        {
            string[] args = JsonHelper.Deserialize<string[]>(arguments);
            ...
            var desiredFields = JsonHelper.Deserialize<string[]>(args[0]);
        ...
        {
            string[] args = JsonHelper.Deserialize<string[]>(searchCriteria);

            ContactSearchParams searchParams = new ContactSearchParams();
            try
            {
                searchParams.fields = JsonHelper.Deserialize<string[]>(args[0]);
                searchParams.options = JsonHelper.Deserialize<SearchOptions>(args[1]);
            }
            catch (Exception)
            {
            ...
            Microsoft.Phone.UserData.Contacts deviceContacts = new Microsoft.Phone.UserData.Contacts();
