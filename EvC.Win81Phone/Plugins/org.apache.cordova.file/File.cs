...
namespace evc.Plugins.org.apache.cordova.file
{
    /// <summary>
    ...
    public class File : BaseCommand
    {
        ...
        private string[] getOptionStrings(string options)
        {
            ...
            try
            {
                optStings = JsonHelper.Deserialize<string[]>(options);
            }
            catch (Exception)
            {
        ...
        public void IsDirectoryOrFileExist(string options, bool isDirectory)
        {
            ...
            FileOptions fileOptions = JsonHelper.Deserialize<FileOptions>(args[0]);
        ...
        public void write(string options)
        {
            ...
            try
            {
                ...
                char[] dataToWrite = isBinary ? JsonHelper.Deserialize<char[]>(data) :
                    data.ToCharArray();
        ...
        private void GetFileOrDirectory(string options, bool getDirectory)
        {
            ...
            try
            {
                fOptions.CreatingOpt = JsonHelper.Deserialize<CreatingOptions>(args[2]);
            }
            catch (Exception)
            {
                DispatchCommandResult(new PluginResult(PluginResult.Status.JSON_EXCEPTION), callbackId);
