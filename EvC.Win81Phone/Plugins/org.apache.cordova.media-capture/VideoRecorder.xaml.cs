...
namespace evc.Plugins.org.apache.cordova
{
    public partial class VideoRecorder : PhoneApplicationPage
    {
        ...
        /// </summary>
        public event EventHandler<VideoCaptureTask.VideoResult> Completed;
        ...
        /// </summary>
        private VideoCaptureTask.VideoResult result = new VideoCaptureTask.VideoResult(TaskResult.Cancel);
        ...
        /// </summary>
        private VideoCaptureTask.VideoResult SaveVideoClip()
        {
            try
            {
                using (IsolatedStorageFile isoFile = IsolatedStorageFile.GetUserStoreForApplication())
                {
                    ...
                    {
                        return new VideoCaptureTask.VideoResult(TaskResult.Cancel);
                    }
                    ...
                    VideoCaptureTask.VideoResult result = new VideoCaptureTask.VideoResult(TaskResult.OK);
            ...
            {
                return new VideoCaptureTask.VideoResult(TaskResult.None);
            }
        }
        ...
        private void StartVideoRecording()
        {
            ...
            {
                this.result = new VideoCaptureTask.VideoResult(TaskResult.None);
                this.NavigateBack();
            }
        }
