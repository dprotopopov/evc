...
namespace evc.Plugins.org.apache.cordova
{
    /// <summary>
    ...
    public class Capture : BaseCommand
    {
        ...
        public void captureImage(string options)
        {
            try
            {
                try
                {
                    ...
                    string args = JsonHelper.Deserialize<string[]>(options)[0];
                    this.captureImageOptions = String.IsNullOrEmpty(args) ? CaptureImageOptions.Default : JsonHelper.Deserialize<CaptureImageOptions>(args);
        ...
        public void captureAudio(string options)
        {
            try
            {
                ...
                {
                    string args = JsonHelper.Deserialize<string[]>(options)[0];
                    this.captureAudioOptions = String.IsNullOrEmpty(args) ? CaptureAudioOptions.Default : JsonHelper.Deserialize<CaptureAudioOptions>(args);
        ...
        public void captureVideo(string options)
        {
            try
            {
                ...
                {
                    string args = JsonHelper.Deserialize<string[]>(options)[0];
                    this.captureVideoOptions = String.IsNullOrEmpty(args) ? CaptureVideoOptions.Default : JsonHelper.Deserialize<CaptureVideoOptions>(args);
        ...
        public void play(string options)
        {
            try
            {
                ...
                try
                {
                    file = String.IsNullOrEmpty(options) ? null : JsonHelper.Deserialize<MediaFile[]>(options)[0];
        ...
        private void audioRecordingTask_Completed(object sender, AudioCaptureTask.AudioResult e)
        {
        ...
        private void videoRecordingTask_Completed(object sender, VideoCaptureTask.VideoResult e)
        {
