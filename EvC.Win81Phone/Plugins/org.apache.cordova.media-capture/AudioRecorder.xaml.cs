...
namespace evc.Plugins.org.apache.cordova
{
    ...
    public partial class AudioRecorder : PhoneApplicationPage
    {
        ...
        /// </summary>
        public event EventHandler<AudioCaptureTask.AudioResult> Completed;
        ...
        /// </summary>
        private AudioCaptureTask.AudioResult result = new AudioCaptureTask.AudioResult(TaskResult.Cancel);
        ...
        /// </summary>
        /// <returns></returns>
        private AudioCaptureTask.AudioResult SaveAudioClipToLocalStorage()
        {
            if (this.memoryStream == null || this.memoryStream.Length <= 0)
            {
                return new AudioCaptureTask.AudioResult(TaskResult.Cancel);
            }
            ...
            try
            {
                using (IsolatedStorageFile isoFile = IsolatedStorageFile.GetUserStoreForApplication())
                {
                    ...
                    AudioCaptureTask.AudioResult result = new AudioCaptureTask.AudioResult(TaskResult.OK);
