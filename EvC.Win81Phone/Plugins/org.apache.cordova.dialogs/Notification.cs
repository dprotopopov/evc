...
namespace evc.Plugins.org.apache.cordova.dialogs
{
    public class Notification : BaseCommand
    {
        ...
        public void prompt(string options)
        {
            ...
            string[] buttonLabels = JsonHelper.Deserialize<string[]>(buttonLabelsArray);
            ...
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                ...
                if (page != null)
                {
                    ...
                    if (grid != null)
                    {
                        ...
                        string[] labels = JsonHelper.Deserialize<string[]>(alertOpts.buttonLabel);
        ...
        public void vibrate(string vibrateDuration)
        {
            ...
            try
            {
                string[] args = JsonHelper.Deserialize<string[]>(vibrateDuration);
